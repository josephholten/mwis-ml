...
NodeWeight perform_reduction(const MISConfig& config, std::unique_ptr<branch_and_reduce_algorithm>& reducer, graph_access& G, graph_access& rG, const std::vector<NodeID>& reverse_mapping) {
